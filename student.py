...
class Student(Person):
    ...
    def financial(self):
        ...
        if self.student_number in students:
            ...
            # Assign random money to student data
            # self.assign_money()
            ...
            while True:
                ...
                if choice == "1":
                    ...
                    self.assign_money()
                    budget = student_data.get("financial_id", {}).get("budget")
                    print("Your current budget is: Rial".format(budget))

                elif choice == "2":
                    amount = float(input("Enter the amount to pay: R"))
                    ...
                    if amount <= budget:
                        ...
                        Student.save_student_data(students)
                        print("Payment of R{} has been successfully made.".format(amount))
                        print("Your current budget is: R{}".format(budget))
                    else:
